...
<table class="table table-striped">
	...
	<?php
		...
		$pkg = getBuyerPackages('compleate');
		if ($pkg!==false) {
			//debug($pkg);
			foreach($pkg as $k=>$v) {
				if (!is_array($v)) {
				...
				?>
					<tr data-user-id="<?php echo $v->id;?>">
						...
						<td class="text-center">
							<a href="<?php echo $cfg['options']['siteurl'];?>/buyerPkgInfo/<?php echo $v->id;?>"><i class="fa fa-cogs"></i></a>
						</td>
					</tr>
				...
				?>
					<tr data-user-id="<?php echo $gv->id;?>" class="bg-unread">
						...
						<td class="text-center">
							<a href="<?php echo $cfg['options']['siteurl'];?>/buyerPkgInfo/<?php echo $gv->id;?>/inbox"><i class="fa fa-cogs"></i></a>
						</td>
					</tr>					
				<?php
				}
